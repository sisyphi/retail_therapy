<script>
	import '../app.pcss';
    import rt_logo from '../lib/images/rt-logo.svelte';
...
<style>
    /* header::after {
        ...
        background-image: url('../lib/images/rip-south.png');
        background: blue;
    } */

    :global(.tear-south) {
        background-color: transparent;
        /* filter: drop-shadow(0 0.3rem 0.6rem black); */
